...
_ppidtest:     file format elf32-i386
...
int main(int argc, char *argv[]){
  ...
  18:	75 1d                	jne    37 <main+0x37>
        printf(1,"My pid is  %d\n",getpid());
  1a:	e8 f3 02 00 00       	call   312 <getpid>
    }    
    else{
        wait();
        printf(1,"My pid is  %d\n",getppid());
  ...
  32:	e8 5b 02 00 00       	call   292 <exit>
    ...
    if(child == 0){
        ...
        wait();
  37:	e8 5e 02 00 00       	call   29a <wait>
        printf(1,"My pid is  %d\n",getppid());
  3c:	e8 f9 02 00 00       	call   33a <getppid>
  41:	eb dc                	jmp    1f <main+0x1f>
  43:	66 90                	xchg   %ax,%ax
  45:	66 90                	xchg   %ax,%ax
  47:	66 90                	xchg   %ax,%ax
  49:	66 90                	xchg   %ax,%ax
...
putc(int fd, char c)
{
 ...
 528:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
          s = "(null)";
 52b:	b8 3f 07 00 00       	mov    $0x73f,%eax
...
malloc(uint nbytes)
{
 ...
 69f:	76 3f                	jbe    6e0 <malloc+0xa0>
    ...
    if(p == freep)
 6a1:	39 05 e0 09 00 00    	cmp    %eax,0x9e0
 ...
 6c6:	e8 e5 fe ff ff       	call   5b0 <free>
  return freep;
 6cb:	8b 15 e0 09 00 00    	mov    0x9e0,%edx
      }
      freep = prevp;
      return (void*)(p + 1);
    }
 ...
 6ec:	89 78 04             	mov    %edi,0x4(%eax)
      ...
      freep = prevp;
 6ef:	89 15 e0 09 00 00    	mov    %edx,0x9e0
      return (void*)(p + 1);
 ...
 70d:	09 00 00 
 710:	c7 05 e4 09 00 00 e4 	movl   $0x9e4,0x9e4
 717:	09 00 00 
    base.s.size = 0;
