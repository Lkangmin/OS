...
int main(int argc, char *argv[])
{
  ...
  72:	e8 5b 03 00 00       	call   3d2 <getshmem>
  ...
  7a:	89 c3                	mov    %eax,%ebx
    printf(1, "A message from the parent process: %s\n", shmem);
  7c:	50                   	push   %eax
  7d:	68 b0 07 00 00       	push   $0x7b0
  82:	6a 01                	push   $0x1
  84:	e8 f7 03 00 00       	call   480 <printf>
    printf(1, "Now this should trigger page fault for the child process.\n");
  89:	59                   	pop    %ecx
  8a:	58                   	pop    %eax
  8b:	68 d8 07 00 00       	push   $0x7d8
  90:	6a 01                	push   $0x1
  92:	e8 e9 03 00 00       	call   480 <printf>
    strcpy(shmem, "The child process is not allowed to write in the shared memory!");
  97:	58                   	pop    %eax
  98:	5a                   	pop    %edx
  99:	68 14 08 00 00       	push   $0x814
  9e:	53                   	push   %ebx
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 41f:	f7 f6                	div    %esi
 421:	0f b6 92 e4 08 00 00 	movzbl 0x8e4(%edx),%edx
  }while((x /= base) != 0);
...
putc(int fd, char c)
{
 ...
 598:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
          s = "(null)";
 59b:	b8 dc 08 00 00       	mov    $0x8dc,%eax
...
free(void *ap)
{
 ...
 621:	a1 80 0b 00 00       	mov    0xb80,%eax
static Header base;
static Header *freep;
...
free(void *ap)
{
 ...
 677:	89 08                	mov    %ecx,(%eax)
  freep = p;
 679:	a3 80 0b 00 00       	mov    %eax,0xb80
}
 67e:	5b                   	pop    %ebx
 67f:	5e                   	pop    %esi
 680:	5f                   	pop    %edi
 ...
 69a:	03 53 fc             	add    -0x4(%ebx),%edx
    ...
    p->s.ptr = bp;
  freep = p;
 69d:	a3 80 0b 00 00       	mov    %eax,0xb80
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
...
malloc(uint nbytes)
{
 ...
 6b9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6bc:	8b 15 80 0b 00 00    	mov    0xb80,%edx
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
 ...
 70f:	76 3f                	jbe    750 <malloc+0xa0>
    ...
    if(p == freep)
 711:	39 05 80 0b 00 00    	cmp    %eax,0xb80
 ...
 736:	e8 e5 fe ff ff       	call   620 <free>
  return freep;
 73b:	8b 15 80 0b 00 00    	mov    0xb80,%edx
      }
      freep = prevp;
      return (void*)(p + 1);
    }
 ...
 75c:	89 78 04             	mov    %edi,0x4(%eax)
      ...
      freep = prevp;
 75f:	89 15 80 0b 00 00    	mov    %edx,0xb80
      return (void*)(p + 1);
 ...
 774:	eb e9                	jmp    75f <malloc+0xaf>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 776:	c7 05 80 0b 00 00 84 	movl   $0xb84,0xb80
 77d:	0b 00 00 
 780:	c7 05 84 0b 00 00 84 	movl   $0xb84,0xb84
 787:	0b 00 00 
    base.s.size = 0;
 78a:	b8 84 0b 00 00       	mov    $0xb84,%eax
 78f:	c7 05 88 0b 00 00 00 	movl   $0x0,0xb88
 796:	00 00 00 
